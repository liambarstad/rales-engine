...
RSpec.feature "merchant can output total revenue" do
  it "with date" do
    ...
    transaction1 = create(:transaction, invoice: invoice1, result: 'success', created_at: "2012-03-16 11:55:05 UTC")
    transaction2 = create(:transaction, invoice: invoice2, result: 'success', created_at: "2012-03-16 11:55:05 UTC")
    transaction3 = create(:transaction, invoice: invoice3, result: 'success')

    total1 = invoice_item1.quantity * invoice_item1.unit_price
    total2 = invoice_item2.quantity * invoice_item2.unit_price
    total = total1 + total2
    proposed_total = Merchant.total_revenue("2012-03-16 11:55:05".to_datetime)
